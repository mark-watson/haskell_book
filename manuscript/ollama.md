...
The example in this chapter is very similar to the example in the last chapter that uses Google's Gemini model APIs. Currently Google makes using their APIs close to being for free but I still like running open weight models on my own laptop.
