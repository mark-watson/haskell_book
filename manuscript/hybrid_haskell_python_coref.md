...
1. Extend the python coreference resolution server API to return confidence scores for resolved mentions, and update the Haskell client to parse them.
2. Create a simple terminal-based interactive dashboard that displays the text and highlights the resolved coreference clusters in distinct colors.
